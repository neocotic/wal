...
public class Frame extends JFrame implements StyledComponent {
	...
	public Frame() {
		...
		UndecoratedUtils.registerMoveComponent(this);
		UndecoratedUtils.registerMoveComponent(windowPanel);
		UndecoratedUtils.registerResizeComponent(this);
		UndecoratedUtils.registerTitleComponent(windowPanel);
	}
