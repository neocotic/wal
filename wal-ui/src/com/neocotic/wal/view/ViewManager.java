...
public class ViewManager
{
    ...
    public void addChangeListener(Class<? extends View> viewClass, ViewChangeListener listener)
    {
        ...
        else
        {
            ...
            if (details == null) { throw new ViewNotFoundException(viewClass); }
    ...
    {
        if (viewClass == null) { throw new IllegalArgumentException("null viewClass"); }
    ...
    public void addToStack(String name)
    {
        ...
        if (details == null) { throw new ViewNotFoundException(name); }
    ...
    public void back()
    {
        ...
        else if (previousView == null) { throw new IllegalStateException("no previous view found"); }

        ViewDetails details = getDetails(previousView);

        if (details == null) { throw new ViewNotFoundException(previousView); }
    ...
    {
        if (frame == null) { throw new IllegalStateException("null frame"); }
    ...
    private ViewDetails getDetails(Class<? extends View> viewClass)
    {
        for (ViewDetails details : viewMap.values())
        {
            if (details.getViewClass().equals(viewClass)) { return details; }
        }
    ...
    public String[] getViewNames(Class<? extends View> viewClass)
    {
        ...
        if (isAnnotationValid(info)) { return info.value(); }
    ...
    public void register(Class<? extends View> viewClass)
    {
        ...
        else if (!hasValidAnnotation(viewClass)) { throw new IllegalArgumentException(
                "null or empty ViewInfo annotation for viewClass"); }
    ...
    public void register(String name, Class<? extends View> viewClass)
    {
        ...
        else if (isActive(name)) { throw new ViewException("cannot unregister active view: " + name); }
    ...
    {
        if (classPathChecked) { throw new IllegalStateException("class path already checked"); }
    ...
    public void reload(String action)
    {
        ...
        if (view == null) { throw new IllegalStateException("null view"); }

        ViewDetails details = getDetails(view);

        if (details == null) { throw new ViewNotFoundException(view); }
    ...
    public void setFrame(Frame frame)
    {
        ...
        else if (this.frame != null) { throw new IllegalStateException("frame has already been set"); }
    ...
    private void unregister(ViewDetails details)
    {
        if (details != null)
        {
            ...
            if (isActive(details)) { throw new ViewException("cannot unregister active view: " + details.getName()); }
